#!/usr/bin/env python3
"""
Outlook OAuth2 Reauth — alle Scopes für mail_to_calendar.py
Starten: python3 outlook_reauth.py
"""
...
def main():
    ...
    print("\n✓ Token gespeichert! Outlook-Kalender-Sync funktioniert wieder.")
    print(f"  Token läuft ab: access_token gültig für {tok.get('expires_in', '?')} Sekunden")
