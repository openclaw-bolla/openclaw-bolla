...
BODY_DE = """<p>Hallo,</p>
<p>vielen Dank für Ihr Interesse an &bdquo;AURORA&ldquo;! Im Anhang finden Sie das Buch als E-Book (EPUB), das sich in allen gängigen Leseprogrammen öffnen lässt.</p>
<p>Über eine Erwähnung oder eine kurze Rückmeldung freue ich mich sehr &ndash; es besteht aber keinerlei Verpflichtung. Bei Fragen zur Entstehungsgeschichte (Mensch + KI) stehe ich gern zur Verfügung.</p>
<p>Herzliche Grüße<br>
Chris Mandel<br>
Autor von &bdquo;AURORA&ldquo; &middot; <a href="https://www.amazon.de/dp/B0H6JD2KDJ">amazon.de/dp/B0H6JD2KDJ</a></p>
"""

BODY_EN = """<p>Hello,</p>
<p>thank you for your interest in "AURORA"! Please find the book attached as an e-book (EPUB), which opens in all common reading apps.</p>
<p>I'd be glad about a mention or any feedback &mdash; but there's no obligation at all. Happy to answer any questions about the origin story (human + AI).</p>
<p>Best regards,<br>
Chris Mandel<br>
Author of "AURORA" &middot; <a href="https://www.amazon.com/dp/B0H6JQK6JQ">amazon.com/dp/B0H6JQK6JQ</a></p>
"""
